...
const ProjectCard: React.FC<{
  ...
  const isInProgress =
    project.impact.toLowerCase().includes("in-progress") ||
    project.deliverable.toLowerCase().includes("construction");
        ...
        <div className="p-8 md:p-10 flex-grow flex flex-col relative transition-colors duration-800">
          ...
          <div className="sr-only">
            ...
            <div>
              ...
              This project for {project.client} focused on {project.deliverable}
              . The challenge was to deliver top-tier services that drive
              business growth. As a result, we achieved {project.impact}.
            </div>
            <div>
              Keywords: {project.deliverable.toLowerCase()}, video production,
              brand strategy, digital marketing, Navi Mumbai, project portfolio.
            </div>
          ...
          <div className="mt-auto pt-8 border-t border-zinc-800/10">
            <span className="text-[9px] uppercase font-black tracking-widest text-zinc-400 block mb-2.5">
              Impact
            </span>
