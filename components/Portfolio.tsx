  ...
  return (
    <Reveal delay={index * 100}>
      <div 
        ...
        className="group h-full cursor-pointer relative overflow-hidden bg-zinc-900 border border-zinc-800/50 hover:border-zinc-500 transition-all duration-500 rounded-xl flex flex-col active:scale-[0.98] outline-none focus:ring-2 focus:ring-white/20"
      >
        <div className="aspect-[4/5] relative overflow-hidden bg-zinc-950">
          ...
          <img 
            ...
            className={`w-full h-full object-cover transform group-hover:scale-110 transition-all duration-700 grayscale group-hover:grayscale-0 ${imageLoaded ? 'opacity-100' : 'opacity-0'}`}
          />
        </div>
