      ...
      {isVisible && !isDismissed && (
        ...
        >
          <div className="bg-[#050505] border border-white/10 p-5 rounded-sm shadow-2xl relative">
            ...
            <h4 className="font-serif font-bold text-white mb-2 pr-6">Ready to Scale?</h4>
            <p className="text-zinc-400 text-sm mb-4">Let's build a cinematic brand that dominates your market.</p>
            <Link 
              to="/contact" 
              onClick={handleDismiss}
