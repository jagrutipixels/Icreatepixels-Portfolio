...
export const Hero: React.FC = () => {
  const lineVariants = {
    ...
    visible: (i: number) => ({
      y: 0,
      opacity: 1,
      transition: { delay: i * 0.15 + 3.5, duration: 0.8, ease: [0.76, 0, 0.24, 1] }
    })
  };
    ...
    <section className="relative min-h-[100vh] w-full flex flex-col justify-center px-6 lg:px-12 pt-32 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto flex flex-col items-center text-center gap-10">
        ...
        >
          ...
          <span className="text-[10px] font-bold tracking-widest uppercase text-center">Premium Agency in Navi Mumbai</span>
        </motion.div>

        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-serif font-black leading-[1.05] tracking-tight text-white mb-6 w-full max-w-5xl">
          ...
          <div className="overflow-visible pb-4">
            <motion.div custom={1} variants={lineVariants} initial="hidden" animate="visible" className="flex justify-center items-center flex-wrap gap-x-3 gap-y-2">
