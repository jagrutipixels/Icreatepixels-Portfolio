...
const clients = [
  "GULBADAN TALKIES", "PUPPYCUDDLES", "BHARAT REALTY", "SAVOIR STUDIO", "DBN BRAND", "TECH EV", "BHADIPA"
];
      ...
      <div className="relative w-full flex overflow-hidden bg-white/5 py-6 origin-center -rotate-2">
        ...
        >
          {[...clients, ...clients, ...clients].map((client, i) => (
            <div key={i} className="px-12 text-2xl md:text-4xl font-black uppercase tracking-tighter text-white/20 shrink-0">
              {client}
            </div>
          ))}
        </motion.div>
