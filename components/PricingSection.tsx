      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 relative z-10">
        ...
        <div className="lg:col-span-5 flex flex-col justify-center">
          <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-white mb-6 leading-none">
            Simple & Honest <br/> <span className="text-[#ff4d00]">Pricing.</span>
          </h2>
          <p className="text-zinc-400 max-w-sm mb-8 text-lg">
            No hidden fees. No ridiculous retainers. Just high-end production and development value.
          </p>
        </div>
        ...
        >
          ...
          <span className="text-xs font-bold tracking-widest text-[#ff4d00] uppercase mb-4 block">Premium Package</span>
          <div className="flex items-end gap-2 mb-10">
            <h3 className="text-6xl md:text-8xl font-black tracking-tighter leading-none">₹50k</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
            {[
              ...
              <div key={i} className="flex items-center gap-3">
                ...
                <span className="text-sm font-semibold tracking-wide text-zinc-800">{item}</span>
              </div>
            ))}
          </div>
